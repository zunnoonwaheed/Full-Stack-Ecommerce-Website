    ...
    <div className="f">
      <div className="flex flex-col sm:grid grid-cols-[3fr_1fr_1fr] gap-14 my-10 mt-40 text-sm ">
        <div className="">
          ...
          Discover the ultimate online shopping experience with Forever – where convenience meets style!
          </p>
        </div>
        ...
        <div className="">
          ...
          <ul className="flex flex-col flex-1 text-gray-600">
            ...
            <li className="mb-2">contact@x-mart.com </li>
          </ul>
        </div>
      </div>
      <div>
        ...
        <p className="py-5 text-sm text-center">
          Copyright 2024@ x-mart.com - All Rights Reserved
        </p>
      </div>
    </div>
  );
